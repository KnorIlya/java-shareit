...
public class LoggingAspect {
    ...
    @Pointcut("@within(ru.practicum.shareit.annotation.LogExecution)")
    ...
    public Object log(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        LogExecution annotation = method.getDeclaringClass().getAnnotation(LogExecution.class);
        if (annotation == null) {
            annotation = method.getAnnotation(LogExecution.class);
        }
